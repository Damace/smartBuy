      ...
      child: Column(
        children: [
          ...
          _buildMenuItem(
            ...
            title: 'stock_inventory'.tr,
            subtitle: 'manage_product_stock_levels'.tr,
            onTap: controller.navigateToStockInventory,
            isLast: true,
          ),
        ],
      ),
      ...
      child: Column(
        children: [
          ...
          _buildMenuItem(
            ...
            title: 'inventory_alerts'.tr,
            subtitle: 'stock_notifications_settings'.tr,
            onTap: controller.navigateToInventoryAlerts,
            isLast: true,
          ),
        ],
      ),
