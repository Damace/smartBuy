...
class WishlistView extends GetView<WishlistController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Obx(() {
            if (controller.wishlistItems.isEmpty) return const SizedBox();
            if (controller.isClearing.value) {
  ...
  Widget _buildWishlistCard(Map<String, dynamic> item) {
    ...
    return Dismissible(
      ...
      onDismissed: (_) => controller.removeFromWishlist(item),
      child: Container(
        margin: const EdgeInsets.only(bottom: 12),
          ...
          children: [
            ...
            Column(
              children: [
                // Remove button
                Obx(() {
                  final isRemoving = controller.removingIds.contains(itemId);
                  return IconButton(
                ...
                // Move to cart / Notify me button
                Obx(() {
                  final isMoving = controller.movingToCartIds.contains(itemId);
                  return SizedBox(
                    width: 100,
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            inStock ? AppTheme.primaryColor : Colors.transparent,
                        foregroundColor:
                            inStock ? Colors.white : AppTheme.primaryColor,
                        padding: const EdgeInsets.symmetric(
